...
from data.protein_kmer_count_plus_graph_features import (
    build_protein_kmer_plus_graph_features
)
...
def main():
    ...
    protein_feats = build_protein_kmer_plus_graph_features(proteins)
    ...
    print("\n=== Drug GNN + k-mer Interaction Graph (Cold-Target) ===")
