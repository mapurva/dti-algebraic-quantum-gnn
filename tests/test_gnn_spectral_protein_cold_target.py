...
from data.protein_combined_features import build_protein_kmer_spectral_features
...
def main():
    ...
    protein_feats = build_protein_kmer_spectral_features(proteins)
    ...
    print("\n=== Drug GNN + Spectral Protein Features (Cold-Target) ===")
