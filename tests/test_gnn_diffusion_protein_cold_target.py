...
from data.protein_kmer_diffusion_features import (
    build_protein_kmer_diffusion_features
)
...
def main():
    ...
    protein_feats = build_protein_kmer_diffusion_features(proteins)
    ...
    print("\n=== Drug GNN + Diffusion Protein Features (Cold-Target) ===")
