...
def run_experiment(split_name, split_fn):
    print(f"\n===== MLP under {split_name.upper()} SPLIT =====\n")
    ...
    # Apply split
    train_df, val_df, test_df = split_fn(interactions, seed=42)
...
def main():
    run_experiment("cold-drug", cold_drug_split)
    run_experiment("cold-target", cold_target_split)
