...
from data.protein_kmer_weighted_diffusion_features import (
    build_protein_kmer_weighted_diffusion_features
)
...
def main():
    ...
    protein_feats = build_protein_kmer_weighted_diffusion_features(proteins)
    ...
    print("\n=== Drug GNN + Weighted Diffusion Protein Graph (Cold-Target) ===")
